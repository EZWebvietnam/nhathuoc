			...
			<div id="wrapper">
				...
				<div id="content">
					...
					<div id="manual_side">
						...
						<!--end .box_manual-->
						<div class="clear"><img height="10px" src="<?php echo base_url();?>template/ezwebvietnam/nhathuoc_template/images/spacer.gif" /></div>
						<div class="manual_side_adv">
							<div><a href="www.tuvangiamcan.vn" target="_self"><img class="lazy" alt="Banner right manual" src="/data/banner/lrh1347068541.jpg" border="0"></a></div>
						</div>
						<!--end #manual_side_adv-->
				...
				<div id="footer">
					...
					<div id="footer_ext">
						...
						<div id="copy_info">
							...
							<div class="copy">
								<div class="counter">
									<div><span class="b">Số lượt truy cập:</span> <span>11.747.348</span></div>
									<div class="cler"></div>
									<div><span class="b">Số người trực tuyến:</span> <span>103</span></div>
								</div>
								<div class="clear"></div>
