<div class="manual_cat">
	<div class="man_top">
		...
		<div class="man_top_m">Liên hệ</div>
	...
	<div class="manual_cat_">
		...
		<div class="man_detail_desc">
			Bạn có thắc mắc về sản phẩm?<br>
			Bạn muốn được tư vấn từ các dược sỹ để tìm ra sản phẩm phù hợp nhất?<br>
			Bạn cần thêm thông tin?<br>
			Xin vui lòng liên hệ theo thông tin dưới đây:<br>
			<div>
		...
		<div class="man_detail_share">
			...
			<div id="share_tool">
				...
				<div class="print_mail">
					...
					<a href="mailto:mailto:youremail@example.com?body=<?php echo full_url_($_SERVER);?>" class="mail">Gửi mail</a>
				</div>
