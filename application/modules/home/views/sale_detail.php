<div class="manual_cat">
	...
	<div class="manual_cat_">
		<div class="man_detail_title">
			<h1><?php echo $detail_sale[0]['title'];?></h1>
		</div>
		<div class="m_date">Ngày hết hạn: <?php $date = strtotime($detail_sale[0]['exp_date']);echo date('d/m/Y',$date);?></div>
		<div class="man_detail_desc">
			<?php echo $detail_sale[0]['content'];?>
		</div>
		<!--end .man_detail_desc-->
		<div class="clear"></div>
