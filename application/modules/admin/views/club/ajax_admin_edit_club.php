...
<div class="m-pop">
    ...
    <form action="<?php echo base_url(); ?>admin/clubadmin/edit/<?php echo $club_detail[0]['id_about']?>" enctype="multipart/form-data" method="post" accept-charset="utf-8" id="adminform" name="adminform">
        <table class="form" style="width: 1200px;">
            <tr>
                <td class="label">Nội dung</td>
                <td colspan="3">
                    <textarea id="editor2" name="editor2"><?php echo $club_detail[0]['content_about']?></textarea>
                    <script type="text/javascript">
            ...
            , submitHandler: function(form) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        $.fancybox.close();
                        reload_callback("<?php echo base_url(); ?>admin/clubadmin/list_club/?nocache="+Math.random(), page, 'club_content');
                        show_msg(data.msg);
                    }
                });
            }
