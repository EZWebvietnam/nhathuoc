...
class Salemodel extends CI_Model
{
    ...
    {
        $sql="SELECT *,sale_off.title as title_save, sale_off.content as content_sale,sale_off.exp_date as exp_sale,sale_off.id as id_sale FROM sale_off INNER JOIN product ON product.id_product = sale_off.id_product LIMIT $offset,$number";
