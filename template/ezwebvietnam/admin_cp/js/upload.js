...
function fileUpload2(form, action_url, div_id,current_action) {
    // Create the iframe...
    var iframe = document.createElement("iframe");
    iframe.setAttribute("id", "upload_iframe");
    iframe.setAttribute("name", "upload_iframe");
    ...
    var eventHandler = function () {
            ...
            //document.getElementById(div_id).innerHTML = content;
            var b = JSON.parse(content);
            document.getElementById('file_thumb').value=b.file_name
            // Del the iframe...
            setTimeout('iframeId.parentNode.removeChild(iframeId)', 250);
            document.getElementById(div_id).innerHTML = "Upload thành công";
        }
...
function fileUpload3(form, action_url, div_id,current_action) {
    // Create the iframe...
    var iframe = document.createElement("iframe");
    iframe.setAttribute("id", "upload_iframe");
    iframe.setAttribute("name", "upload_iframe");
    ...
    var eventHandler = function () {
            ...
            //document.getElementById(div_id).innerHTML = content;
            var b = JSON.parse(content);
            document.getElementById('file_scroll').value=b.file_name
            // Del the iframe...
            setTimeout('iframeId.parentNode.removeChild(iframeId)', 250);
            document.getElementById(div_id).innerHTML = "Upload thành công";
        }
